...
@Component({
  selector: 'xb-bidsowdialogbox',
  templateUrl: './bidsowdialogbox.component.html',
  styleUrls: ['./bidsowdialogbox.component.scss']
})
export class BidSowDialogBoxComponent implements OnInit {
